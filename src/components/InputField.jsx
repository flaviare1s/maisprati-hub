export const InputField = ({
  ...
  const inputProps = {
    ...
    ...register(name, validation),
    className:
      "border border-border-input rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-logo placeholder:text-sm placeholder:text-gray-muted bg-bg-input text-gray-700",
  };
