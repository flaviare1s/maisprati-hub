  ...
  return (
    ...
    >
      <div className="flex flex-col border-b mb-4 h-[80vh] bg-light rounded-2xl">
        <header className="text-base md:text-lg font-bold bg-red-logo w-full h-[60px] rounded-t-2xl text-white text-center py-2 flex items-center justify-between p-4">
