  ...
  return (
    <div className="bg-blue-logo text-light h-[calc(100vh-80px)] w-full flex flex-col items-center justify-center relative">
      ...
      <div className='flex flex-col items-center'>
        <h2 className='absolute top-0 left-0 lg:left-[200px] text-4xl sm:text-5xl lg:text-5xl xl:text-7xl font-bold max-w-[220px] m-10 sm:max-w-[300px] lg:max-w-[700px] leading-[50px] sm:leading-[80px] lg:leading-[150px] z-20'>Conexão Inteligente. Projetos Perfeitos.</h2>
